...
export const HomePage = () => {
    ...
    return (
        <div className="space-y-0 overflow-x-hidden bg-white dark:bg-gray-950">
            ...
            {/* --- HERO SECTION --- */}
            <header className="relative hero-pattern pt-32 pb-20 lg:pt-40 lg:pb-32 -mt-20 overflow-hidden">
                {/* Background Blobs */}
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up animation-delay-400">
                            <button onClick={() => setShowTriage(true)} className="w-full sm:w-auto bg-primary-600 hover:bg-primary-700 text-white px-8 py-4 rounded-full font-bold text-lg shadow-xl shadow-primary-900/10 dark:shadow-none transition-all hover:-translate-y-1 flex items-center justify-center gap-2 ring-4 ring-primary-500/10 dark:ring-primary-400/10">
                                I Need Help Now <ArrowRight size={20} />
                            </button>
                            <button onClick={() => navigate('/resources')} className="w-full sm:w-auto bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 border border-gray-200 dark:border-gray-700 px-8 py-4 rounded-full font-bold text-lg shadow-sm transition-all hover:-translate-y-1 flex items-center justify-center gap-2">
                                <BookOpen size={20} /> Self-Help Library
                            </button>
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 relative mt-12">
                        ...
                        {[
                            ...
                            <div key={idx} className="bg-white dark:bg-gray-900 p-6 rounded-[1.5rem] border border-gray-100 dark:border-gray-800 shadow-sm relative group hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                                <div className={`w-16 h-16 bg-${step.color}-50 dark:bg-${step.color}-900/20 text-${step.color}-600 dark:text-${step.color}-400 rounded-2xl flex items-center justify-center mb-6 text-xl font-bold mx-auto shadow-inner`}>
                                    <step.icon size={32} />
                                </div>
