...
export const Input: React.FC<InputProps> = ({ label, error, className = '', ...props }) => (
    <div className="w-full">
        ...
        <input
            className={`w-full px-4 py-2.5 min-h-[44px] text-base sm:text-sm border rounded-xl focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all bg-white dark:bg-gray-800/80 dark:text-white shadow-sm ${error
